                        ...
                        <button key={i} type="button" onClick={() => applyDate(viewYear, viewMonth, day)}
                          style={{
                            ...
                            background: isSelected
                              ...
                              : isToday
                              ? (isDark ? "rgba(124,58,237,0.2)" : "#f0ebff")
                              : "transparent",
                          ...
                          onMouseEnter={e => { if (!isSelected) e.currentTarget.style.background = isDark ? "rgba(255,255,255,0.07)" : "#f5f3ff"; }}
                          onMouseLeave={e => { if (!isSelected) e.currentTarget.style.background = isToday ? (isDark ? "rgba(124,58,237,0.2)" : "#f0ebff") : "transparent"; }}>
                          {day}
                        </button>
                      );
                    })}
