...
from app.models import meeting as _meeting_models  # noqa: F401  — регистрирует meeting.* в metadata
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    async with engine.begin() as conn:
        ...
        migrations = [
            ...
            "ALTER TABLE video.meeting_chat_files SET SCHEMA public",
            "ALTER TABLE video.meeting_participant_logs SET SCHEMA public",
